...
void abrir_arquivo()
{
    ...
    do
    {
        ...
        //printf("%s",strRegistro.nomedoarquivo);
        //system("pause");
...
void shellSort()
{
    ...
    printf("Tempo gasto: %4.0f ms\n\n",1000*(double)(end-start)/(double)(CLOCKS_PER_SEC));
    printf("%s / Shell Sort\n",strRegistro.nomedoarquivo);
    /*for(int i=0;i<strRegistro.tam;i++){
...
// funçao de selecionar modo de ordenaçao
void selecao(int op)
{
    int arq;
    switch (op)
    ...
    case 0:
        ...
        if(arq==2)
        {
            system("Criar_arquivo\\Criar_arquivo.exe");
            system("cls");
            break;
        }
        else
